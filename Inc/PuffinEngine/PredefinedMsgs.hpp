...
namespace puffin {
    ...
    template<typename T>
    constexpr auto PUFFIN_MSG_SHADER_VALIDATE_ERROR(T shader_name) {
        return "Shader program [" + shader_name + "] validate error.";
    }

    template<typename T>
    constexpr auto PUFFIN_MSG_SHADER_VALIDATE_SUCCESS(T shader_name) {
